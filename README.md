...
Next, I created 2 carefully crafted system prompts, to tailor each AI towards being an expert engineer in the area we are working on for this project. I didn't create this by hand either, I used an AI (ChatGPT 5.1) to do so. I created one for Opus at `./ai/opus_system_prompt.md` and one for Sonnet at `./ai/sonnet_system_prompt.md`.
